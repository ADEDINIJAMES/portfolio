...
const projects = [
  {
    ...
    technologies: ["Java Spring Boot", "ReactJS", "MySQL", "JWT", "Paystack", "Spring Security"],
  ...
  },
  {
    ...
    technologies: ["Java Spring Boot", "ReactJS", "MySQL", "JWT", "Google OAuth", "Spring Security"],
  ...
  },
  {
    ...
    technologies: ["Java", "PHP", "HTML", "CSS", "Bootstrap", "MySQL", "Apache Tomcat"],
    type: "Web Application",
  },
  {
    ...
    technologies: ["Spring Boot", "H2 Database", "PostgreSQL", "JWT", "Google OAuth2"],
    type: "REST API",
  },
  {
          ...
          <div className="lg:col-span-2">
            <div className="grid gap-6">
              {projects.map((project, index) => (
                <Card
                  key={index}
                  className={`group glass-card hover-lift hover-glow transition-all duration-500 animate-fade-in-up animate-delay-${(index + 1) * 100}`}
                >
                  <CardHeader>
                    <div className="flex items-start justify-between">
                      <div className="space-y-2">
                        ...
                        <CardDescription className="gradient-text font-medium">{project.type}</CardDescription>
                      </div>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {project.technologies.map((tech, techIndex) => (
                        <span
                          key={tech}
                          className={`px-3 py-1 glass text-xs rounded-full transition-all duration-300 hover:scale-105 hover:gradient-bg hover:text-white animate-fade-in-up animate-delay-${(techIndex + 1) * 50}`}
                        >
                          {tech}
                        </span>
                      ))}
